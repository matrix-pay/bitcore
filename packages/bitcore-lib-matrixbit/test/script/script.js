...
describe('Script', function() {
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      var address = Address.fromString('matrixbit:qqrsvl0mxgmedtnzgu7hwwerjy680j2m3y0apfgyuq');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0x07067dfb323796ae62473d773b23913477c95b89 OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress().toString().should.equal('matrixbit:qqrsvl0mxgmedtnzgu7hwwerjy680j2m3y0apfgyuq');
    });
    it('should create script from testnet address', function() {
      var address = Address.fromString('mbxtest:qr5hxqzh6uag54ypzfdd3sh0n9l395vp3qpwpht2ns');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0xe9730057d73a8a5481125ad8c2ef997f12d18188 OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress().toString().should.equal('mbxtest:qr5hxqzh6uag54ypzfdd3sh0n9l395vp3qpwpht2ns');
    });
  ...
  describe('#buildScriptHashOut', function() {
    ...
    it('inherits network property from other script', function() {
      var s1 = new Script.fromAddress(new Address('Si5Xdprnn2Y1QhwxrPd7kcS7X4SQUJLAkh'));
    ...
    it('inherits network property form an address', function() {
      var address = new Address('SVb7mg2WYLYiSP2QGiTUK5sJQ7sz2fPS3X');
  ...
  describe('getData returns associated data', function() {
    ...
    it('for a P2PKH address', function() {
      var address = Address.fromString('MXsuixj3ahmXYnbdDXCx83FvWYJdgKLpNr');
  ...
  describe('toAddress', function() {
    ...
    it('for a P2PKH address', function() {
      var stringAddress = 'matrixbit:qqzu2q7mjyp3wrha8fm69yfx2mp5hmdv2ykslw5ra7';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    it('for a P2SH address', function() {
      var stringAddress = 'matrixbit:ppmprepcpnudf4glf3zkr0zajka96sgnaq650cvvas';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    ...
    it('works for p2pkh output', function() {
      ...
      script.toAddress().toString().should.equal('matrixbit:qrywzxcwkrf265mzmz20qjyssdql5cdkuyts57xza5');
    });
    it('works for p2pkh input', function() {
      ...
      s2.toAddress().toString().should.equal('matrixbit:qprjfgyvctp82eddvwrup69dvggw63afzgxxrakpfe');
    });
    ...
    it('works for p2sh output', function() {
      ...
      script.toAddress().toString().should.equal('matrixbit:pzva9yz34uxzntwtjpqqx36jhwnamce7x58jju5nda');
    });
    it('works for p2sh input', function() {
      ...
      script.toAddress().toString().should.equal('matrixbit:pz30sxmypnge5lv0eyshlt0w5jzu5axu3sksfgvs7e');
    });
