...
describe('PrivateKey', function() {
  ...
  it('creates an address as expected from WIF, livenet', function() {
    ...
    privkey.publicKey.toAddress().toString().should.equal('matrixbit:qqtv79nz6p246lxt6ja526nhmgdk5qtn9gyas0ec76');
  });
  ...
  it('creates an address as expected from WIF, testnet', function() {
    ...
    privkey.publicKey.toAddress().toString().should.equal('mbxtest:qpv7q8crqr6872wprm7626kzkt4gafx8gchjn2ttrs');
  });
