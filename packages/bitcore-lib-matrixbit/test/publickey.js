...
describe('PublicKey', function() {
  ...
  describe('#toAddress', function() {
    ...
    it('should output this known mainnet address correctly', function() {
      ...
      address.toString().should.equal('matrixbit:qp3awknl3dz8ezu3rmapff3phnzz95kansq2fg3ahv');
    });
    ...
    it('should output this known testnet address correctly', function() {
      ...
      address.toString().should.equal('mbxtest:qz82yclajj49kq3cnqk5khs9h2qx5drfru4t6agmlt');
    });
  ...
  describe('hashes', function() {
    ...
    var data = [
      ['Kz21uDXrgR3KbWSQc4UBZRDkYwc2itojVFFaxciFok9upmNGdKmE', 'MXsuixj3ahmXYnbdDXCx83FvWYJdgKLpNr'],
      ['L3bDv1CGpsb3Q5vcQVuU1P7q5odLbdMxRcZMHFaVtgGbQ1sggZd3', 'MXmGcLxXM9KNhr1QwDiTtJt3i2pEzFw3zt'],
      ['L5j6kc7D6cWp5kcCCU5GmAx4v68qVyjj3BLoBrcykydS7tRnndqG', 'Mhd9Y355Sm871rTgqiYTiPZDGVEABgbXnG'],
      ['L3mF2CEEgppwpzp8TePpL8YKWz6ddqkVWNECmXnJSYUnicH82HDv', 'MiZhLkNReUqqjV7s7vXauT4ao7PbGx1T4g']
    ];
