...
describe('Address', function() {
  ...
  var buf = Buffer.concat([new Buffer([51]), pubkeyhash]);
  var str = 'matrixbit:qq7rlg754h903afdtvvy8967zgj5sf5exusdmrpf65';
  ...
  describe('Cashaddr', function() {
    ...
    //
    var t = [
      ['MXsuixj3ahmXYnbdDXCx83FvWYJdgKLpNr', 'matrixbit:qqrsvl0mxgmedtnzgu7hwwerjy680j2m3y0apfgyuq'],
      ['MXmGcLxXM9KNhr1QwDiTtJt3i2pEzFw3zt', 'matrixbit:qqzu2q7mjyp3wrha8fm69yfx2mp5hmdv2ykslw5ra7'],
      ['Mhd9Y355Sm871rTgqiYTiPZDGVEABgbXnG', 'matrixbit:qpc76z3ke4c3v6nll3qq8x0wgf3nnz7hvcquyeqeq0'],
      ['MiZhLkNReUqqjV7s7vXauT4ao7PbGx1T4g', 'matrixbit:qp7rurfhntljg34zk8h4ty8twrjlgp74fy33m6gewx'],
      ['Saydu1XQUHCMzXdTMa7qxtatvptRRB89FR', 'matrixbit:pztp3gv2khcm7jp887xvlv76yhqwnnruaqvhyrmttr'],
      ['SfVUJJB8yKbw3hR2NXFt2vvNSpXQMjWmqi', 'matrixbit:prremxwq98v06llm49xe80t9ky23aealpqgyqpjqw0'],
    ];
    var i;
    ...
    it('should be able to convert a testnet address to a cashaddr', function() {
      ...
      a.toCashAddress().should.equal('mbxtest:qry5cr6h2qe25pzwwfrz8m653fh2tf6nus03mvu5st');
    });


    it('should be able to convert a testnet address to a cashaddr without prefix', function() {
      var a = new Address('mysKEM9kN86Nkcqwb4gw7RqtDyc552LQoq');
      a.toCashAddress(false).should.equal('mbxtest:qry5cr6h2qe25pzwwfrz8m653fh2tf6nus03mvu5st');
    });
  ...
  // livenet valid
  var PKHLivenet = [
    'MiZhLkNReUqqjV7s7vXauT4ao7PbGx1T4g',
    'matrixbit:qqrsvl0mxgmedtnzgu7hwwerjy680j2m3y0apfgyuq',
    'MXmGcLxXM9KNhr1QwDiTtJt3i2pEzFw3zt',
    'MiZhLkNReUqqjV7s7vXauT4ao7PbGx1T4g',
    '    MiZhLkNReUqqjV7s7vXauT4ao7PbGx1T4g   \t\n'
  ];
  ...
  // livenet p2sh
  var P2SHLivenet = [
    'matrixbit:pqw4y6vk7teqxerxzenny8y3fnu2kpuskcvnc6dd5x',
    'SPy3MXHZgRi4ntqWJcFWn6WXBd5WC7sY3u',
    'SeGgxTBvQxMwqwkB4sNTDPkGVhroBMy6K6',
    'SUAFdZVVQd9f8tcXe3PdirfHx3wuP4ytoB',
    '\tShqHuYSYJsohJv2QBmh2RL2anu5v5mb6rR \n \r'
  ];

  // testnet p2sh
  var P2SHTestnet = [
    'mbxtest:pq6e8l8th53ww3u3hkmy4uuqvlqht5tj7gy9fqrca5',
    '2NEWDzHWwY5ZZp8CQWbB7ouNMLqCia6YRda',
    '2MxgPqX1iThW3oZVk9KoFcE5M4JpiETssVN',
    '2Mx8X5qQy7r1S4g1sFpbpT3G7bKcziuNCgd'
  ];
  ...
  //testnet valid
  var PKHTestnet = [
    'mbxtest:qp77nf332zlztxt52zrm44lplmumj645xvhsm7xkj5',
    'mrzifGDVGLGCAeF1FQLJQq4WHw1Fjp1uYT',
    'mzc9JGKNmwSZKwR3EYPy4r6nvq8EoBbsQV',
    'mbxtest:qr8ff2ealfd696fxf83ucwzlvhv36evftqmuvyes0h'
  ];

  describe('validation', function() {

    it('getValidationError detects network mismatchs', function() {
      var error = Address.getValidationError('MXsuixj3ahmXYnbdDXCx83FvWYJdgKLpNr', 'testnet');
      should.exist(error);
    });

    it('isValid returns true on a valid livenet address', function() {
      Address.isValid('MXsuixj3ahmXYnbdDXCx83FvWYJdgKLpNr', 'livenet').should.equal(true);
    });

    it('isValid returns false on network mismatch', function() {
      Address.isValid('MXsuixj3ahmXYnbdDXCx83FvWYJdgKLpNr', 'testnet').should.equal(false);
      Address.isValid('MXsuixj3ahmXYnbdDXCx83FvWYJdgKLpNr', 'regtest').should.equal(false);
    });

    it('isValid returns true on network match on cashaddr', function() {
      Address.isValid('matrixbit:qqrsvl0mxgmedtnzgu7hwwerjy680j2m3y0apfgyuq', 'mainnet').should.equal(true);
      Address.isValid('mbxreg:qzfr50nmkv8c8cx09j8d7pweyx9pg0nzgg5vmqd0qd', 'regtest').should.equal(true);
      Address.isValid('mbxtest:qr8ff2ealfd696fxf83ucwzlvhv36evftqmuvyes0h', 'testnet').should.equal(true);
    });
    ...
    it('isValid works as expected even after enableRegtest() is called', function() {
      ...
      Address.isValid('mbxreg:qzfr50nmkv8c8cx09j8d7pweyx9pg0nzgg5vmqd0qd', 'regtest').should.equal(true);
      Address.isValid('mbxtest:qr8ff2ealfd696fxf83ucwzlvhv36evftqmuvyes0h', 'testnet').should.equal(true);
      Address.isValid('matrixbit:qqrsvl0mxgmedtnzgu7hwwerjy680j2m3y0apfgyuq', 'testnet').should.equal(false);
      Address.isValid('mbxreg:qzfr50nmkv8c8cx09j8d7pweyx9pg0nzgg5vmqd0qd', 'testnet').should.equal(false);
      Address.isValid('mbxtest:qr8ff2ealfd696fxf83ucwzlvhv36evftqmuvyes0h', 'mainnet').should.equal(false);
    ...
    it('addresses with whitespace are validated correctly', function() {
      var ws = '  \r \t    \n matrixbit:qp3awknl3dz8ezu3rmapff3phnzz95kansq2fg3ahv \t \n            \r';
      var error = Address.getValidationError(ws);
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('matrixbit:qp3awknl3dz8ezu3rmapff3phnzz95kansq2fg3ahv');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('matrixbit:qp0jaf7jwcf0zlxguv7kcaj05hsxz2lcqu0rjlftfx');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('matrixbit:qqazje5ucx2l672lc8cundsa5q9lwdm3rclkavaayz');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('matrixbit:qqazje5ucx2l672lc8cundsa5q9lwdm3rclkavaayz');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('matrixbit:qrywzxcwkrf265mzmz20qjyssdql5cdkuyts57xza5');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('matrixbit:qrywzxcwkrf265mzmz20qjyssdql5cdkuyts57xza5');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('matrixbit:pznw6jhnz5n3uet7uvrc9r655sm9lfwjpuuer37fjy');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('matrixbit:pznw6jhnz5n3uet7uvrc9r655sm9lfwjpuuer37fjy');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'matrixbit:qqazje5ucx2l672lc8cundsa5q9lwdm3rclkavaayz';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = 'matrixbit:prs56lc0fa3hysd3g5pmfhpjqyk3pyaqsg88lw0z8j';
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: matrixbit:qq7rlg754h903afdtvvy8967zgj5sf5exusdmrpf65, type: pubkeyhash, network: livenet>';
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('matrixbit:pzdumagr7ru8w46s8alws4lzruv2c75vsu46t86e8e');
    ...
    it('works on testnet also', function() {
      ...
      address.toString().should.equal('mbxtest:pzdumagr7ru8w46s8alws4lzruv2c75vsu9en2etqu');
    });
