...
var privateKey = new PrivateKey('cVkaTDn9m1qFSCjW6wJJKqjpP4JJw1A1CgduywBtLg9x1VJRmo9P', Network.testnet);
console.log(privateKey);
var exported = privateKey.toWIF();
console.log(exported);
// 7TuP128JuHkqQ7b5E96enwSxJM5cWMmkkrrv3Qe1cDjf3MKz6x14
var imported = PrivateKey.fromWIF('cVkaTDn9m1qFSCjW6wJJKqjpP4JJw1A1CgduywBtLg9x1VJRmo9P');
console.log(imported);
var publicKey = privateKey.toPublicKey();
console.log(publicKey);
var error = PrivateKey.getValidationError('cVkaTDn9m1qFSCjW6wJJKqjpP4JJw1A1CgduywBtLg9x1VJRmo9P', Network.testnet);
if (error) {
    // handle the error
    console.log('ERROR');
}
...
var privateKey = new PrivateKey('cSwy8sNq8XaeFAGzuEbAhRdnwUxuJA2CgRPDWmpEED3U5FGpeRX7', Network.testnet);
console.log(privateKey);
var exported = privateKey.toWIF();
console.log(exported);
// 7TuP128JuHkqQ7b5E96enwSxJM5cWMmkkrrv3Qe1cDjf3MKz6x14
var imported = PrivateKey.fromWIF('cSwy8sNq8XaeFAGzuEbAhRdnwUxuJA2CgRPDWmpEED3U5FGpeRX7');
console.log(imported);
var publicKey = privateKey.toPublicKey();
console.log(publicKey);
var error = PrivateKey.getValidationError('cSwy8sNq8XaeFAGzuEbAhRdnwUxuJA2CgRPDWmpEED3U5FGpeRX7', Network.testnet);
if (error) {
  // handle the error
  console.log('ERROR');
}
...
var privateKey = new PrivateKey('cRyQkyY1qrsXXNa4EDBSw3yEZNYvgTipoA76yPePb8EsHh2DKLk7', Network.testnet);
console.log(privateKey);
var exported = privateKey.toWIF();
console.log(exported);
// 7TuP128JuHkqQ7b5E96enwSxJM5cWMmkkrrv3Qe1cDjf3MKz6x14
var imported = PrivateKey.fromWIF('cRyQkyY1qrsXXNa4EDBSw3yEZNYvgTipoA76yPePb8EsHh2DKLk7');
console.log(imported);
var publicKey = privateKey.toPublicKey();
console.log(publicKey);
var error = PrivateKey.getValidationError('cRyQkyY1qrsXXNa4EDBSw3yEZNYvgTipoA76yPePb8EsHh2DKLk7', Network.testnet);
if (error) {
  // handle the error
  console.log('ERROR');
}
...
var privateKey = new PrivateKey('cR3uXN3SRdxUhuhAsruRtu7mU8TRpjbe5iSq3fguJjsP1EXS262W', Network.testnet);
console.log(privateKey);
var exported = privateKey.toWIF();
console.log(exported);
// 7TuP128JuHkqQ7b5E96enwSxJM5cWMmkkrrv3Qe1cDjf3MKz6x14
var imported = PrivateKey.fromWIF('cR3uXN3SRdxUhuhAsruRtu7mU8TRpjbe5iSq3fguJjsP1EXS262W');
console.log(imported);
var publicKey = privateKey.toPublicKey();
console.log(publicKey);
var error = PrivateKey.getValidationError('cR3uXN3SRdxUhuhAsruRtu7mU8TRpjbe5iSq3fguJjsP1EXS262W', Network.testnet);
if (error) {
  // handle the error
  console.log('ERROR');
}
