...
describe('MultiSigScriptHashInput', function() {
  ...
  var privateKey1 = new PrivateKey('L3mF2CEEgppwpzp8TePpL8YKWz6ddqkVWNECmXnJSYUnicH82HDv');
  var privateKey2 = new PrivateKey('L1KKGXP73PPMfNV3zPHpLaBjeHuYM16Pk9Ym35MwPLWQkbfA1FJ9');
  var privateKey3 = new PrivateKey('KwsVKNhesy9yeZmjd1uizLGcA2nzQCjF2JDFJekHHYL5TwXGtCC3');
  var public1 = privateKey1.publicKey;
  var public2 = privateKey2.publicKey;
  var public3 = privateKey3.publicKey;
  var address = new Address('SWwzJGHannhVJFqVuXr7Bgs4NAgU8t9KXt');

  var output = {
    address: 'SNTjTwQxTzGpjM5oRzhbdzf8qVyaKgNqno',
